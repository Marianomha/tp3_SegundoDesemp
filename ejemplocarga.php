...
if (InsertarRegistro($MiConexion) == !false){
          ...
          <!--  <?php if (!empty($Mensaje)) { ?>
           <div class="bs-component">
            ...
            <div class="tile-body">
              ...
              ?>
              <?php  require_once 'funciones/fecha_resolucion.php'; ?>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" placeholder="Ingresa los detalles..." name="Descripcion_Solicitud" value=""></textarea>
                </div>
                <div class="form-group">
                  ...
                  <div class="form-check">
                    <label class="form-check-label">
                      <input class="form-check-input" type="radio" name= "tipo" value="<?php echo $Listado_Tipos[$i]['ID']; ?>"
                      <?php echo (!empty($_POST['tipo']) && $_POST['tipo'] == $Listado_Tipos[$i]['ID']) ? 'checked' : '';?> ><?php echo $Listado_Tipos[$i]['DENOMINACION']; ?>
                      <input type="hidden" name="FechaResolucion" value="<?php echo calcularFechaEntrega($Fecha_Actual, $_POST["tipo"]); ?>">
                    </label>
                  </div>
                  <?php  } ?>
                <?php 
                 ...
                 // $Id_usuario= $_SESSION['Usuario_Id'];
                  //$posted_Id_Usuario= $_POST['Id_usuario'];
              ...
              <button class="btn btn-primary" type="submit" value= "registrar" name="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="index.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
            </div>
          </div>
        </div>
